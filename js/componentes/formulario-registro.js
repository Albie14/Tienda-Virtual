    ...
    constructor(){
        ...
        this.innerHTML = `
            <div class="seccion-registro">
                <form class="formulario" id="formulario-registro">
                    <div class="formularioGrupo" id="grupoUsuario">
                        <div class="indicacionesFormulario">
                            ...
                            <div class="formularioGrupoInput">
                                <input type="text" autocomplete="given-name" class="formularioInput" name="nombre" id="nombre" placeholder="ingresa tu nombre">
                    ...
                    <div class="formularioGrupo" id="grupoNombre">
                        <div class="indicacionesFormulario">
                            ...
                            <div class="formularioGrupoInput">
                                <input type="text" autocomplete="family-name" class="formularioInput" name="apellido" id="apellido" placeholder="ingresa tu apellido">
                    ...
                    <div class="formularioGrupo" id="grupoCorreo">
                        <div class="indicacionesFormulario">
                            ...
                            <div class="formularioGrupoInput">
                                <input type="email" autocomplete="username" class="formularioInput" name="correo" id="correo" placeholder="correo@correo.com">
                                <i class="iconoError fa-solid fa-circle-xmark"></i>
                            </div>
                        </div>
                    ...
                    <div class="formularioGrupo" id="grupoTerminos">
                        ...
                        <p class="formularioInputError" id="msjErrorTerminos">Debe aceptar los terminos y condiciones</p>
                    </div>
                ...
                <button type="button" id="btnEliminarCuenta">Eliminar cuenta</button>
            </div>`;
    }
    connectedCallback(){
        this.querySelector('#formulario-registro').addEventListener('submit', (e)=>{
            e.preventDefault();
