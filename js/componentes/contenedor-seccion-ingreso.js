                ...
                <div class="datos-ingresar container-cambio-clave">
                        ...
                        <form action="submit"  id="form-datos-recuperar-clave">
                            <div class="grupo-datos-recuperar">
                                ...
                                <div class="grupo-input-recuperacion">
                                    ...
                                    <i id="icon-err-correo-recuperacion" class="iconoErrorIngresar fa-solid fa-circle-xmark"></i>
                                </div>
                                <p class="formularioInputErrorIngresar" id="msj-err-correo-recuperacion">correo electronico no encontrado</p>
                            </div>
                        ...
                        <form action="submit"  id="form-verificacion-clave-defecto">
                            <div class="grupo-datos-recuperar">
                                ...
                                <div class="grupo-input-recuperacion">
                                    ...
                                    <i id="icon-err-clave-defecto" class="iconoErrorIngresar fa-solid fa-circle-xmark"></i>
                                </div>
                                <p class="formularioInputErrorIngresar" id="msj-err-clave-defecto">clave incorrecta</p>
                            </div>
                            <div class="btn-correo-defecto">
                    ...
                    <div class="grupo-nueva-clave">
                        <form action="submit"  id="form-nueva-clave">
                            <input type="text" name="username" autocomplete="username" value="usuario@example.com" style="display: none;" disabled>
                            ...
                            <div class="grupo-datos-recuperar div-nueva-clave">
                                ...
                                <div class="input-clave-ingresar">
                                    ...
                                    <i id="icon-err-nueva-clave" class="iconoErrorIngresar fa-solid fa-circle-xmark"></i>
                                </div>
                                <p class="formularioInputErrorIngresar" id="msj-err-nueva-clave">La contraseña debe ser de 4 a 12 digitos</p>
                            </div>
                                <div class="grupo-datos-recuperar div-nueva-clave">
                                    ...
                                    <div class="input-clave-ingresar">
                                        ...
                                        <i id="icon-err-confirmacion-nueva-clave" class="iconoErrorIngresar fa-solid fa-circle-xmark"></i>
                                    </div>
                                    <p class="formularioInputErrorIngresar" id="msj-err-confirmacion-nueva-clave">Ambas contraseñas deben ser iguales</p>
                                </div>    
                            <div class="btn-correo-defecto">
